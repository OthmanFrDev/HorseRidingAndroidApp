            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.hide_nav:
                        ...
                        break;
                    case R.id.home_nav:
                        i = new Intent(EditFormUser.this, DashboardActivity.class);
                        EditFormUser.this.startActivity(i);
                        break;
                    case R.id.setting_nav:
                        Toast.makeText(EditFormUser.this, "Vous êtes dans la page de modification :D", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.logout_nav:
                        SessionManager sessionManager = new SessionManager(EditFormUser.this);
