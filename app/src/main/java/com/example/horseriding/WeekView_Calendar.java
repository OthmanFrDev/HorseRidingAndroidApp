...
public class WeekView_Calendar extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        JsonArrayRequest jArray=new JsonArrayRequest(Request.Method.GET, "http://192.168.111.1:45455/seances/"+startDateString+"/"+endDateString+"/"+id, null, new Response.Listener<JSONArray>() {
            @Override
