...
public class SeanceController extends AppCompatActivity implements
                    ...
                    new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public void onTimeSet(TimePicker view, int hourOfDay,
                            ...
                            if(hourOfDay>=0&&hourOfDay<=7||hourOfDay>18) {
                                ...
                                Toast.makeText(SeanceController.this, "work hours be between 00:08 to 18:00", Toast.LENGTH_LONG).show();
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                try {
                                    if (error.networkResponse.statusCode == 400 || error.networkResponse.statusCode == 404) {
                                        Toast.makeText(SeanceController.this, "Erreur: Informations incorrects", Toast.LENGTH_LONG).show();
                                    }
                                    Log.e(MainActivity.class.getSimpleName(), error.toString());
                                } catch (NullPointerException ex) {
                                    Toast.makeText(SeanceController.this, "Server issue try later", Toast.LENGTH_LONG).show();
                                }
                            }
                        }
                );
                MySingleton.getInstance(SeanceController.this).addToRequestQueue(jsonObjectRequest);

            }

        } catch (Exception e) {
            Toast.makeText(SeanceController.this, e.getMessage(), Toast.LENGTH_LONG).show();
            Log.d("postseance", e.getMessage());
        }
        ...
        try {
            ...
            JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET, WS.URL+ "users", null, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    ArrayAdapter<User> adapter=new ArrayAdapter<User>(SeanceController.this,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                                ...
                                Log.d("getmonitors", error.getMessage());


                        }
                    }
            );
            MySingleton.getInstance(SeanceController.this).addToRequestQueue(req);
        } catch (Exception ex) {
        ...
        try {
            ...
            JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET, "http://192.168.111.1:45455/clients", null, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    ArrayAdapter<Client> adapter=new ArrayAdapter<Client>(SeanceController.this,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                                ...
                                Log.d("getclients", error.getMessage());
