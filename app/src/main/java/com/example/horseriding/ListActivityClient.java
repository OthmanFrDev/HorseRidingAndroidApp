...
//                }
    ...
    public void PostUser(View view) {
        ...
        if (intent.getStringExtra("click").equals("0")) {
            addIntent = new Intent(ListActivityClient.this, UserController.class);
        }
        if (intent.getStringExtra("click").equals("1")) {
            addIntent = new Intent(ListActivityClient.this, UserController.class);/*task*/
        }
        if (intent.getStringExtra("click").equals("2")) {
            addIntent = new Intent(ListActivityClient.this, DayView_calendar.class);/*seance*/
        }
        if (intent.getStringExtra("click").equals("3")) {
            addIntent = new Intent(ListActivityClient.this, UserController.class);/*client*/
        }
